...
/* Various standard manipulations */
  ...
  extern int binsert (bstring s1, int pos, const bstring s2,
                      unsigned char fill);
  extern int binsertch (bstring s1, int pos, int len, unsigned char fill);
  extern int breplace (bstring b1, int pos, int len, const bstring b2,
                       unsigned char fill);
  extern int bdelete (bstring s1, int pos, int len);
  extern int bsetstr (bstring b0, int pos, const bstring b1,
                      unsigned char fill);
...
/* Scan/search functions */
  ...
  extern int bisstemeqcaselessblk (const bstring b0, const void *blk,
                                   int len);
...
#define bstrrchr(b,c) bstrrchrp ((b), (c), blength(b)-1)
  ...
  extern int bfindreplace (bstring b, const bstring find, const bstring repl,
                           int pos);
  extern int bfindreplacecaseless (bstring b, const bstring find,
...
/* String split and join functions */
  ...
  extern struct bstrList *bsplitstr (const bstring str,
...
/* Stream functions */
  ...
  extern int bssplitstrcb (struct bStream *s, const bstring splitStr,
                           int (*cb) (void *parm, int ofs,
                                      const bstring entry), void *parm);
